...
import com.taas.petsconnect.Adapter.messagesAdapter;
...
public class chatwindo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmessagesAdpter = new messagesAdapter(chatwindo.this,messagesArrayList);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                senderImg= snapshot.child("uprofile").getValue().toString();
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                database.getReference().child("chats")
                                        ...
                                        .push().setValue(messagess).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                Toast.makeText(chatwindo.this, "Received uid: " + reciverUid, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        });
